...
iPod Classic的Rockbox里的Mpeg Player plugin介绍： "The Mpeg Player is a video player plugin capable of playing back MPEG-1 and MPEG-2"
...
单个flv文件转码为Rockbox支持的mpeg视频格式，代码为：
